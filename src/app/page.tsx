...
export default function Home() {
  return (
    ...
    <div className="flex flex-col items-center justify-center">
      <div className="font-noto-sans-jp text-center text-2xl text-white bg-black h-screen flex flex-col items-center justify-center">
        <h1>
          <span className="font-bold">Luqman Hadi</span><br />
          <span className="font-light text-base">ルクマン　ハディ</span>
        </h1>
        <div className="mt-6 flex justify-center gap-4">
          <a
            ...
            className="flex items-center gap-2 px-4 py-2 rounded hover:bg-blue-700 text-white font-semibold transition"
          >
