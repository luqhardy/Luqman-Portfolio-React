...
/**
 * lucide-react v1 dropped brand marks, so the two we need are inlined here.
 * They take the same props as a lucide icon (currentColor, 24x24 viewBox) so
